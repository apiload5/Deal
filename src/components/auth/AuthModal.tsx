    ...
    try {
      ...
      if (isSignUp) {
        ...
        try {
          ...
          console.warn('Saved user to local session, Supabase write notice:', e);
        }
      } else {
        ...
        try {
          ...
          if (userDoc) {
            updatedUser = {
              ...
              kycStatus: userDoc.kyc_status || 'none',
              isOverseasPakistani: userDoc.is_overseas_pakistani,
              overseasCountry: userDoc.overseas_country,
              nicopNumber: userDoc.nicop_number,
              hasRdaAccount: userDoc.has_rda_account,
