...
const HERO_IMAGES = [
  {
    ...
    location: 'Sector F-7, E-11 & F-6, Islamabad'
  },
  {
    url: '/hero/hero2.jpg',
    title: 'Modern Architecture Houses in DHA Lahore',
    location: 'DHA Phase 5, 6 & 8, Lahore'
  },
  {
    url: '/hero/hero3.jpg',
    title: 'Waterfront Penthouses & Seaview Apartments',
    location: 'Clifton & Defense Phase 8, Karachi'
  },
  {
    url: '/hero/hero4.jpg',
    title: 'Exclusive Gated Communities & Mega Projects',
    location: 'Bahria Town & Capital Smart City, Rawalpindi'
  },
  {
    url: '/hero/hero5.jpg',
  ...
  {
    url: '/hero/hero6.jpg',
    title: 'Luxury Farmhouses & Eco Enclaves',
    location: 'Bedian Road Lahore & Chak Shahzad Islamabad'
  },
  {
    url: '/hero/hero7.jpg',
    title: 'High-Rise Residential Towers & Suites',
    location: 'Askari 11 Lahore & Emaar Oceanfront Karachi'
  },
  {
    url: '/hero/hero8.jpg',
    title: 'Smart City Residential Enclaves',
    location: 'Faisal Hills, Wah Cantt & Multan'
  },
  {
    url: '/hero/hero9.jpg',
    title: 'Hillside Cottages & Vacation Homes',
    location: 'Murree Expressway & Abbottabad Hills'
  },
  {
    url: '/hero/hero10.jpg',
    title: 'Deep Sea Port Industrial & Commercial Plots',
    location: 'Gwadar Master Plan & University Town Peshawar'
  }
];
  ...
  return (
    <div className="relative min-h-[88vh] flex items-center justify-center overflow-hidden pt-6 pb-16 bg-slate-950">
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 w-full pt-4">
        ...
        <div className="glass-card-glow backdrop-blur-2xl rounded-3xl p-5 sm:p-7 space-y-4">
                ...
                <button
                  ...
                  className={`min-h-[38px] px-4 py-2 flex items-center justify-center rounded-xl text-xs font-bold transition-all text-center ${
                    purpose === tab.id
                      ...
                      : 'text-slate-200 hover:text-white hover:bg-white/15 bg-slate-900/40 border border-white/10'
                  }`}
                >
                  {tab.label}
                </button>
          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-2.5 items-center">
            ...
            {/* City Selector */}
            <div className="md:col-span-3 bg-slate-950/50 backdrop-blur-md border border-white/20 rounded-xl px-3 py-2.5 flex items-center space-x-2 focus-within:border-orange-500 transition-colors">
            ...
            {/* Keyword Input */}
            <div className="md:col-span-5 bg-slate-950/50 backdrop-blur-md border border-white/20 rounded-xl px-3 py-2.5 flex items-center space-x-2 focus-within:border-orange-500 transition-colors">
