            ...
            <div className="flex flex-wrap items-center gap-2">
              ...
              {onOpenProfile && (
                <button
                  ...
                  className="bg-slate-900 hover:bg-slate-800 border border-slate-700 text-slate-200 px-4 py-2.5 rounded-xl text-xs font-bold transition-all"
                >
                  ⚙️ {isAgencyOrBuilder ? 'Edit Agency Profile & SECP KYC' : 'Edit Profile & KYC'}
                </button>
              )}
              <button
                ...
                <div>
                  {b.paymentStatus === 'escrow_held' && (
                    <button
                      ...
                      className="bg-emerald-600 hover:bg-emerald-500 text-white px-3.5 py-1.5 rounded-xl text-[11px] font-bold transition-all flex items-center space-x-1"
                    >
                      <CheckCircle2 className="w-3.5 h-3.5" />
                      <span>Request Final Escrow Release to Seller</span>
                    </button>
                  )}
                  {b.paymentStatus === ('release_requested' as any) && (
                    <span className="text-amber-400 font-bold text-[11px] flex items-center gap-1 bg-amber-500/10 px-2.5 py-1 rounded-lg border border-amber-500/20">
                      <Clock className="w-3.5 h-3.5" /> Pending Final Admin Approval & Disbursement
                    </span>
                  )}
                </div>
