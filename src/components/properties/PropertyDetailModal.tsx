...
export const PropertyDetailModal: React.FC<PropertyDetailModalProps> = ({
  ...
  // Live Views State - Tracks unique IP/device views
  const [viewsCount, setViewsCount] = useState<number>(property?.views || 1);

  useEffect(() => {
    if (property?.id) {
      const res = store.recordUniquePropertyView(property.id);
            ...
            <div className="flex flex-wrap items-center gap-1.5 sm:gap-2">
              ...
              {(property.isFeatured || property.isPremium) && (
                <span className="px-2.5 py-0.5 rounded-full text-[10px] font-black uppercase bg-gradient-to-r from-amber-400 via-yellow-300 to-amber-500 text-slate-950 flex items-center shadow-lg border border-yellow-200">
                  <Star className="w-3 h-3 mr-1 text-slate-950 fill-slate-950" /> FEATURED TOP AD
                </span>
              )}
        ...
        <div className="mt-4 space-y-3">
          ...
          >
            ...
            <div className="absolute top-3 right-3 flex items-center space-x-2 pointer-events-none">
              ...
              <div className="bg-slate-950/80 backdrop-blur-md px-3 py-1 rounded-xl text-xs font-bold text-white flex items-center space-x-1 border border-slate-800 shadow-md">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:flex lg:flex-wrap gap-2 border-b border-slate-800 py-3 mt-4 w-full">
          {[
            ...
            <button
              ...
              className={`min-h-[38px] sm:min-h-[40px] px-2.5 sm:px-3 py-1.5 sm:py-2 inline-flex items-center justify-center text-center rounded-xl text-[11px] sm:text-xs font-bold transition-all border leading-none whitespace-nowrap ${
                activeTab === t.id
              ...
              <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                    ...
                    <div className="flex items-center gap-2">
                      {property.allowOnlineToken ? (
                        <button
                          ...
                          className="min-h-[38px] sm:min-h-[42px] gradient-btn text-white px-3.5 sm:px-5 py-2 rounded-xl text-xs sm:text-sm font-bold shadow-lg shadow-orange-500/20 hover:brightness-110 inline-flex items-center justify-center leading-none whitespace-nowrap"
                        >
                        ...
                        <button
                          ...
                          className="min-h-[38px] sm:min-h-[42px] bg-slate-900 border border-orange-500/40 text-orange-400 hover:bg-orange-500 hover:text-white px-3 sm:px-4 py-2 rounded-xl text-xs sm:text-sm font-bold transition-all inline-flex items-center justify-center gap-1.5 leading-none whitespace-nowrap"
                        >
                ...
                <div className="grid grid-cols-4 gap-3 text-center">
                  <div className="p-3 rounded-xl bg-slate-900 border border-slate-800 flex flex-col items-center justify-center">
                    <Bed className="w-4 h-4 text-orange-400 mb-1" />
                    <p className="text-[11px] sm:text-xs font-bold text-white leading-tight">{property.beds} Beds</p>
                  </div>
                  <div className="p-3 rounded-xl bg-slate-900 border border-slate-800 flex flex-col items-center justify-center">
                    <Bath className="w-4 h-4 text-orange-400 mb-1" />
                    <p className="text-[11px] sm:text-xs font-bold text-white leading-tight">{property.baths} Baths</p>
                  </div>
                  <div className="p-3 rounded-xl bg-slate-900 border border-slate-800 flex flex-col items-center justify-center">
                    <Maximize2 className="w-4 h-4 text-orange-400 mb-1" />
                    <p className="text-[11px] sm:text-xs font-bold text-white leading-tight">{property.sqft} sqft</p>
                  </div>
                  <div className="p-3 rounded-xl bg-slate-900 border border-slate-800 flex flex-col items-center justify-center">
                    <Building className="w-4 h-4 text-orange-400 mb-1" />
                    <p className="text-[11px] sm:text-xs font-bold text-white capitalize leading-tight">{property.furnished}</p>
                  </div>
                </div>
                  ...
                  <div>
                    ...
                    <div className="grid grid-cols-2 sm:grid-cols-3 gap-2">
                      {property.features.map(f => (
                        <div key={f} className="inline-flex items-center gap-2 text-xs text-slate-200 bg-slate-900 border border-slate-800 p-2.5 rounded-xl">
                          <CheckCircle2 className="w-3.5 h-3.5 text-orange-400 shrink-0" />
                          <span className="truncate leading-none">{f}</span>
                        </div>
                      ))}
                    </div>
                  </div>
              ...
              <div className="space-y-4">
                <div className="p-5 rounded-2xl bg-slate-950/90 border border-slate-800 space-y-4 shadow-xl">
                  ...
                  <div className="flex items-center space-x-3 pb-3 border-b border-slate-800">
                    <div className="w-12 h-12 rounded-2xl bg-orange-500/20 text-orange-400 font-black text-lg flex items-center justify-center overflow-hidden border border-orange-500/30 shrink-0 shadow-md">
                    ...
                    <div className="min-w-0 flex-1">
                      <p className="text-sm font-bold text-white truncate">{property.ownerName || property.agencyName || 'Property Lister'}</p>
                      
                      {/* Explicit Lister Designation: Direct Owner vs Agent vs Builder vs Agency */}
                      {property.userRole === 'user' || !property.userRole ? (
                        <div className="mt-0.5">
                          <span className="inline-flex items-center gap-1 text-[10px] font-bold text-emerald-400 bg-emerald-500/10 px-2 py-0.5 rounded-lg border border-emerald-500/20">
                            <ShieldCheck className="w-3 h-3 text-emerald-400" /> Direct Property Owner (ذاتی مالک)
                          </span>
                          <p className="text-[9px] text-slate-400 mt-0.5">Direct Deal • Zero Broker Commission (0% ڈیلر کمیشن)</p>
                        </div>
                      ) : property.userRole === 'agent' ? (
                        <div className="mt-0.5">
                          <span className="inline-flex items-center gap-1 text-[10px] font-bold text-blue-400 bg-blue-500/10 px-2 py-0.5 rounded-lg border border-blue-500/20">
                            <Award className="w-3 h-3 text-blue-400" /> Certified Real Estate Agent
                          </span>
                          <p className="text-[10px] text-amber-400 font-medium truncate mt-0.5">{property.agencyName || 'Registered Agent'}</p>
                        </div>
                      ) : property.userRole === 'builder' ? (
                        <div className="mt-0.5">
                          <span className="inline-flex items-center gap-1 text-[10px] font-bold text-purple-400 bg-purple-500/10 px-2 py-0.5 rounded-lg border border-purple-500/20">
                            <Building2 className="w-3 h-3 text-purple-400" /> Builder / Project Developer
                          </span>
                          <p className="text-[10px] text-purple-300 font-medium truncate mt-0.5">{property.agencyName || 'Official Developer Listing'}</p>
                        </div>
                      ) : (
                        <div className="mt-0.5">
                          <span className="inline-flex items-center gap-1 text-[10px] font-bold text-amber-400 bg-amber-500/10 px-2 py-0.5 rounded-lg border border-amber-500/20">
                            <Building className="w-3 h-3 text-amber-400" /> Real Estate Agency
                          </span>
                          <p className="text-[10px] text-amber-300 font-medium truncate mt-0.5">{property.agencyName || 'Corporate Brokerage'}</p>
                        </div>
                      )}

                      {prefs.showPhoneNumber ? (
                        <p className="text-[10px] text-slate-400 mt-1 flex items-center gap-1">
                          <Phone className="w-2.5 h-2.5 text-slate-500" /> {property.ownerPhone}
                        </p>
                      ) : (
                        <p className="text-[10px] text-slate-500 italic mt-1">🔒 Phone hidden by lister (Use in-app Chat/Call)</p>
                      )}
                    </div>
                  </div>
                  ...
                  <div className="grid grid-cols-2 gap-2">
                    ...
                    <button
                      onClick={() => onOpenChatWithAgent(property.userId, property.ownerName, property.id, property.title)}
                      className="min-h-[38px] bg-orange-500 hover:bg-orange-600 text-white py-2 px-2.5 rounded-xl text-xs font-bold inline-flex items-center justify-center gap-1.5 shadow-md transition-all leading-none whitespace-nowrap"
                    >
                    ...
                    {prefs.allowVoiceCall && (
                      <button
                        ...
                        className="min-h-[38px] bg-slate-900 hover:bg-slate-800 text-slate-200 border border-slate-700 py-2 px-2.5 rounded-xl text-xs font-bold inline-flex items-center justify-center gap-1.5 transition-all leading-none whitespace-nowrap"
                      >
                    ...
                    {(prefs.allowVideoCall || prefs.allowWebRTCCall) && (
                      <button
                        ...
                        className="min-h-[38px] bg-purple-950/80 hover:bg-purple-900/80 text-purple-200 border border-purple-500/40 py-2 px-2.5 rounded-xl text-xs font-bold inline-flex items-center justify-center gap-1.5 transition-all leading-none whitespace-nowrap"
                      >
                    ...
                    {prefs.allowWhatsApp && (
                      <a
                        ...
                        className="min-h-[38px] bg-emerald-950/80 hover:bg-emerald-900/80 text-emerald-300 border border-emerald-500/40 py-2 px-2.5 rounded-xl text-xs font-bold inline-flex items-center justify-center gap-1.5 transition-all leading-none whitespace-nowrap"
                      >
                    ...
                    {prefs.telegramUsername && (
                      <a
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        className="min-h-[38px] bg-blue-950/80 hover:bg-blue-900/80 text-blue-300 border border-blue-500/40 py-2 px-2.5 rounded-xl text-xs font-bold inline-flex items-center justify-center gap-1.5 transition-all leading-none whitespace-nowrap"
                      >
                    ...
                    {prefs.signalNumber && (
                      <a
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        className="min-h-[38px] bg-purple-950/80 hover:bg-purple-900/80 text-purple-300 border border-purple-500/40 py-2 px-2.5 rounded-xl text-xs font-bold inline-flex items-center justify-center gap-1.5 transition-all leading-none whitespace-nowrap"
                      >
