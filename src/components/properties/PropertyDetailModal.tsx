                ...
                <div className="p-5 rounded-2xl bg-slate-950/90 border border-slate-800 space-y-4 shadow-xl">
                  ...
                  <div className="flex items-center space-x-3 pb-3 border-b border-slate-800">
                    ...
                    <div className="min-w-0 flex-1">
                      <p className="text-sm font-bold text-white truncate">{property.ownerName || property.agencyName || 'Verified Lister'}</p>
                      <p className="text-xs text-amber-400 font-semibold truncate">{property.agencyName || 'Direct Owner / Agent'}</p>
