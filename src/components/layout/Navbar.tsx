...
export const Navbar: React.FC<NavbarProps> = ({
  ...
  return (
    <header className="sticky top-0 z-50 w-full max-w-full glass-header shadow-2xl">
      {/* Top Banner: Escrow Guarantee */}
      <div className="bg-slate-950/80 border-b border-slate-800/80 py-1 px-2 sm:px-4 text-xs w-full max-w-full backdrop-blur-md">
        <div className="max-w-7xl mx-auto flex items-center justify-between gap-1 sm:gap-2">
          <div className="flex items-center space-x-1 shrink-0">
            <span className="inline-flex items-center px-1.5 sm:px-2 py-0.5 rounded-lg text-[9px] min-[380px]:text-[10px] sm:text-[11px] font-bold bg-amber-500/20 text-white border border-amber-500/40 h-6 sm:h-7 shrink-0">
              <ShieldCheck className="w-3 h-3 sm:w-3.5 sm:h-3.5 mr-0.5 sm:mr-1 text-amber-400 shrink-0" />
              <span>100% Escrow</span>
            </span>
            <span className="hidden md:inline text-slate-400 text-[11px] font-medium truncate">
          ...
          <div className="flex items-center gap-1.5 overflow-x-auto no-scrollbar py-0.5 text-[10px] sm:text-[11px] shrink-0 max-w-full">
            {onInstallPwa && (
              <button
                ...
                className="bg-orange-500/20 hover:bg-orange-500/30 text-white border border-orange-500/40 px-2 py-0.5 sm:py-1 rounded-lg font-bold flex items-center gap-1 transition-all h-6 sm:h-7 shrink-0 whitespace-nowrap"
              >
            ...
            {onOpenOverseasDesk && (
              <button
                ...
                className="hidden sm:flex bg-emerald-500/20 hover:bg-emerald-500/30 text-emerald-300 border border-emerald-500/40 px-1.5 sm:px-2 py-0.5 sm:py-1 rounded-lg font-bold items-center gap-0.5 transition-all h-6 sm:h-7 shrink-0 whitespace-nowrap"
              >
                <Globe className="w-2.5 h-2.5 sm:w-3 sm:h-3 text-emerald-400 shrink-0" />
            ...
            {onOpenRoleGuide && (
              <button
                ...
                className="hidden md:flex bg-purple-500/20 hover:bg-purple-500/30 text-purple-200 border border-purple-500/40 px-1.5 sm:px-2 py-0.5 sm:py-1 rounded-lg font-bold items-center gap-0.5 transition-all h-6 sm:h-7 shrink-0 whitespace-nowrap"
                title="Explore Roles Capabilities & Workflow Guide"
              >
                <Sparkles className="w-2.5 h-2.5 sm:w-3 sm:h-3 text-purple-300 shrink-0" />
            ...
            {onOpenFeatures && (
              <button
                ...
                className="hidden lg:flex bg-amber-500/20 hover:bg-amber-500/30 text-white border border-amber-500/40 px-1.5 sm:px-2.5 py-0.5 sm:py-1 rounded-lg font-bold items-center gap-0.5 transition-all h-6 sm:h-7 shrink-0 whitespace-nowrap"
              >
            ...
            <button
              ...
              className="bg-slate-900 hover:bg-slate-800 text-white border border-slate-700/80 px-1.5 sm:px-2 py-0.5 sm:py-1 rounded-lg font-bold flex items-center gap-0.5 transition-all h-6 sm:h-7 shrink-0 whitespace-nowrap"
            >
              <HelpCircle className="w-2.5 h-2.5 sm:w-3 sm:h-3 text-amber-400 shrink-0" />
        ...
        <div className="flex items-center justify-between h-14 sm:h-16 gap-1">
            ...
            {[
              ...
              <button
                ...
                className={`px-3 py-2 rounded-lg text-xs font-semibold transition-colors ${
                  activeTab === item.id
                    ? 'text-orange-400 bg-orange-500/10 border border-orange-500/20 font-bold'
          ...
          <div className="hidden lg:flex items-center space-x-3">
            ...
            {isGuestUser ? (
              <button
                onClick={onOpenAuth}
                className="bg-slate-800 hover:bg-slate-700 text-white px-3.5 py-2 rounded-xl text-xs font-bold transition-all border border-slate-700"
              >
                Sign In / Register
              </button>
            ) : (
          ...
          <div className="flex lg:hidden items-center space-x-1.5 shrink-0">
            ...
            <button
              onClick={handleListPropertyClick}
              className="gradient-btn text-white px-2.5 py-1.5 rounded-xl text-[11px] font-bold flex items-center space-x-1 shadow-md shrink-0"
            >
            ...
            <button
              ...
              className="p-1.5 rounded-xl text-slate-300 hover:text-white bg-slate-900 border border-slate-800 shrink-0"
          ...
          <div className="flex-1 overflow-y-auto p-4 sm:p-6 space-y-4 pb-20">
            ...
            <div className="space-y-1 bg-slate-950/60 border border-slate-800/80 rounded-2xl p-2">
              ...
              {[
                ...
                { id: 'map', label: 'Interactive Map Search', desc: 'Explore Sector Pins', icon: '🗺️' },
