    ...
    <div className="space-y-6 my-6">
      ...
      {builders.length === 0 ? (
        <div className="glass-card rounded-2xl p-10 text-center border border-slate-800/80 my-8 space-y-3 max-w-md mx-auto">
          ...
          <h3 className="text-base font-bold text-white">No Developers Registered Yet</h3>
          <p className="text-xs text-slate-400">
            Verified real estate developers and builders can register to launch commercial & residential mega projects.
          </p>
        </div>
      ) : (
