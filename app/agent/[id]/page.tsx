// TEMPORARILY DISABLED - This page will be re-enabled later
// Agent profile page - Disabled to fix build issues
...
// TEMPORARY EXPORT - Remove this when re-enabling
export default function DisabledPage() {
  return (
    <div className="container mx-auto px-4 py-8 text-center">
      <h1 className="text-2xl font-bold">Agent Profile</h1>
      <p className="text-muted-foreground mt-2">This page is temporarily disabled for maintenance.</p>
      <p className="text-sm text-muted-foreground mt-1">Will be re-enabled soon.</p>
    </div>
  );
}
