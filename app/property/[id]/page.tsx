// app/property/[id]/page.tsx - COMPLETE WITH STRUCTURED DATA
...
import { Bed, Bath, MapPin, Calendar, Eye, Star, Heart, Share2, Link as LinkIcon } from 'lucide-react'
...
export async function generateMetadata({ params }: PropertyPageProps) {
  ...
  const title = `${property.title} - ${formatPrice(property.price)} | deal.online`
  const description = property.description?.slice(0, 160) || 
    `${property.beds} bed, ${property.baths} bath ${property.property_type} for ${property.purpose} in ${property.cities?.name}. Price: ${formatPrice(property.price)}`
  ...
  return {
    ...
    keywords: [
      ...
      `${property.beds} bed ${property.property_type}`,
      `property in ${property.cities?.name}`,
    ...
    openGraph: {
      ...
      modifiedTime: property.updated_at || property.created_at,
      tags: [property.property_type, property.purpose, property.cities?.name],
    },
    twitter: {
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2">
            ...
            {/* Property details with semantic HTML */}
