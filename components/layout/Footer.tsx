        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <p className="text-sm mb-4">
              Pakistan's most trusted real estate platform. Find your dream property with verified agents.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li><Link href="/premium" className="hover:text-white transition">Premium Listings</Link></li>
